...
public class StudentController{
	 ...
	 * create date:2019-09-05
	 */
	@ApiOperation(value="修改密码", response=CommResult.class)
	@PostMapping(value = "studentChangePassword", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public CommResult studentChangePassword(HttpServletRequest request, StudentEntity entity){
