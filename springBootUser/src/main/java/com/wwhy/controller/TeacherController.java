...
public class TeacherController{
	...
	@PostMapping(value = "teacherChangePassword", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public CommResult teacherChangePassword(HttpServletRequest request, TeacherEntity entity){
