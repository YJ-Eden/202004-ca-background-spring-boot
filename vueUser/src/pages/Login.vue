<template>
  ...
  <div class="note" :style="note">
    <div class="top-row">
      <span class="logo-text" style="float:left;margin-right: -80px;">xxx大学考试成绩管理系统</span>
    </div>
    <!--<div class="left-text">-->
      <!--<p>考试是一种严格的知识水平鉴定方法；</p>-->
      <!--<p>通过考试可以检查学生的学习能力和其它能力。</p>-->
      <!--<p>为了保证结果的公平，考场必须要求有很强的纪律约束，并且专门设有监督考试过程，绝对禁止任何作弊行为，否则将要承担法律和刑事责任。</p>-->
      <!--<p>考试就是让一群拥有不同教育资源的人在一定的时间内完成一份相同的答卷。</p>-->
      <!--<p>然而考试的意义并不局限于此，考试也可以是对于一个目标对一个人进行全方位的考核。因此这样的考试其实就是让社会中来自不同社会地位的人拥有改变自己的机会。</p>-->
    <!--</div>-->
