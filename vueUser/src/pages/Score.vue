  ...
  <div class="mainDiv">
    ...
    <el-row>
      <el-col>
        ...
        <el-form-item>
          <el-select v-model="filtersForm.project" placeholder="请选择科目" style="width: 200px;">
            <el-option
    ...
    <el-dialog
      ...
      <el-form :model="addScoreForm" :rules="rules" ref="addScoreForm">
        ...
        <el-col :span="24">
          <el-form-item label="教学科目" :label-width="formLabelWidth" prop="project">
            <el-select v-model="addScoreForm.project" placeholder="请选择科目" style="width: 100%;">
              <el-option
                v-for="item in projectOptions"
                :key="item.basicCode"
                :label="item.basicName"
        ...
        <el-col :span="24">
          <el-form-item label="成绩单位" :label-width="formLabelWidth" prop="score">
    ...
    <el-dialog
      ...
      <el-form :model="updateScoreForm" :rules="rules" ref="updateScoreForm">
        ...
        <el-col :span="24">
          <el-form-item label="教学科目" :label-width="formLabelWidth" prop="project">
            <el-select v-model="updateScoreForm.project" placeholder="请选择科目" style="width: 100%;">
              <el-option
                v-for="item in projectOptions"
                :key="item.basicCode"
                :label="item.basicName"
